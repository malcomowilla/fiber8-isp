    ...
    const {
     ...
     const handleVerifyOtp = async (e) => {
      ...
      try {
        ...
        setOpenLoad(true)
        setDone(false)
        const users = await fetch('api/verify_otp_email', {
          method: "POST",
          headers: {
    ...
    >
      <div className="w-full max-w-md p-8">
        ...
        >
          ...
          >
            <MdOutlineMarkEmailRead className="text-3xl text-emerald-600 dark:text-emerald-400" />
          </motion.div>
          ...
          >
            We've sent a verification code to your email. Please check your email inbox or spam folder and enter the code to proceed.
          </motion.p>
