      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 font-sans">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <div className="text-center mb-10 sm:mb-14">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-green-100
             dark:bg-indigo-500/10 px-3 py-1 text-xs font-semibold text-green-700
              dark:text-green-300 ring-1 ring-inset ring-green-200
              ...
              return (
                <motion.div
                  ...
                  className={`group relative flex flex-col overflow-hidden rounded-2xl border bg-white dark:bg-slate-900 shadow-sm hover:shadow-xl transition-shadow
                    ${isSelected
                      ? 'border-indigo-400 dark:border-green-500 ring-2 ring-green-400/60 dark:ring-green-500/40'
                      : 'border-slate-200 dark:border-slate-800'}`}
                >
                  {/* Selected badge */}
                  {isSelected && (
                    <div className="absolute top-3 right-3 z-10 flex h-7 w-7 items-center justify-center rounded-full bg-green-600 text-white shadow-lg">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between gap-4">
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 rounded-xl
               ...
               disabled:cursor-not-allowed text-white font-semibold px-6
                py-2.5 text-sm shadow-lg shadow-indigo-600/25 transition-colors"
            >
              {isloading ? (
                <>
