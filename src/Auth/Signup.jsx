...
const scrollIntoViewRefTop = useRef(null)
  ...
  return (
    <>
     <div className="font-sans bg-gray-950 text-white">
      ...
      {/* Hero Section */}
      <section ref={scrollIntoViewRefTop} className="relative   cursor-pointer bg-gradient-to-br
  ...
  <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-green-500 transition-all duration-300 hover:scale-105 animate-fade-in-up">
  ...
  <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-orange-500 transition-all duration-300 hover:scale-105 animate-fade-in-up">
    ...
    <p className="text-gray-400">Coming soon: Seamless remote device configuration and monitoring.</p>
      ...
      <section  ref={scrollIntoViewRef} className="py-20 px-6 bg-gradient-to-br from-gray-900 to-gray-950">
        <h2 className="text-4xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r
         from-blue-400 to-purple-400 animate-slide-in">
         PPOE Pricing Plans
        </h2>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Basic Plan */}
          ...
          <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-blue-500 transition-all duration-300 hover:scale-105 animate-fade-in-up">
            <h3 className="text-2xl font-bold mb-4 text-blue-500">Basic</h3>
...
{/* standard plan */}
          ...
          <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-blue-500 transition-all duration-300 hover:scale-105 animate-fade-in-up">
            <h3 className="text-2xl font-bold mb-4 text-blue-500">Startup</h3>
          ...
          <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-blue-500 transition-all duration-300 hover:scale-105 animate-fade-in-up">
            <h3 className="text-2xl font-bold mb-4 text-blue-500">Silver</h3>
          ...
          <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-blue-500 transition-all duration-300 hover:scale-105 animate-fade-in-up">
            <h3 className="text-2xl font-bold mb-4 text-blue-500">Bronze</h3>
          ...
          <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 hover:border-blue-500 transition-all duration-300 hover:scale-105 animate-fade-in-up delay-400">
            <h3 className="text-2xl font-bold mb-4 text-blue-500">Enterprise</h3>
...
<Link to='/hotspot-pricing'>
        <div className='absolute right-0  text-white text-2xl
