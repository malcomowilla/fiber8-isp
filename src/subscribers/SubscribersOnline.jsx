...
const SubscribersOnline = ({ onlineSessions = [], package_name,
 }) => {

  const [stats, setStats] = useState([]);
  const {formDataSubscriber} = useApplicationSettings()
  ...
  const getPPOEstats = useCallback(
    async() => {
      ...
      try {
        const response = await fetch(`/api/get_total_active_pppoe_users`,
          {
...
export default SubscribersOnline;