 ...
 useEffect(() => {
  ...
  const getInvoices = useCallback(
    async() => {
      ...
      try {
        const response = await fetch(`/api/subscriber_invoices?id=${subscriberId}`, {
...
if (response.status === 401) {
  ...
  // :item, :due_date, :invoice_date, :invoice_number, 
  // :amount, :status, :description, :quantity,
...
<Paper elevation={3} sx={{ p: 3, borderRadius: 2 }}>
  ...
  text-2xl 
        ...
        columns={[
{
            title: <p className=' text-black dark:text-white'>Item</p>,
            field: 'item',
            headerStyle: { fontWeight: 'bold' },
            render: rowData => (
              <Typography variant="body1" sx={{ fontWeight: 500 }}>
                <p className='dark:text-white'>{rowData.item}</p>
              </Typography>
            )
          },
          ...
          {
            title: <p className=' text-black dark:text-white'>Invoice Number#</p>,
          ...
          {
            title: <p className='text-black dark:text-white'>Invoice Date</p>,
            field: 'invoice_date',
            type: 'date',
            headerStyle: { fontWeight: 'bold' },
...

           {
            ...
            headerStyle: { fontWeight: 'bold' },
            render: rowData =>  <p
             className='dark:text-white'>{rowData.description} </p>
          },
          
          {
            title: <p className='text-black dark:text-white'>Due Date</p>,
            field: 'due_date',
            type: 'date',
            headerStyle: { fontWeight: 'bold' },
            render: rowData => (
          ...
          {
            title: <p className='text-black dark:text-white'>Total</p>,
            field: 'total',
            headerStyle: { fontWeight: 'bold' },
            render: rowData => (
              <Typography variant="body1" sx={{ fontWeight: 500 }}>
               <p className='dark:text-white'> ksh {rowData.amount} </p>
              </Typography>
            )
          },
          {
