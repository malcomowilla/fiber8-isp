...
<SettingsCheckbox
    checked={enable_2fa_for_admin_passkeys}
     onChange={handleChangeAdminSettings}
      ...
      description="When enabled, administrators can authenticate using Passkeys, a secure and phishing-resistant method based on public-key cryptography. Instead of relying on passwords or one-time codes, Passkeys allow seamless authentication using biometrics (fingerprint or Face ID) 
      or device-based authentication, enhancing security and user experience."
