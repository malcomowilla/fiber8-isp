...
<div className='bg-yellow-50 dark:bg-yellow-900 p-4 rounded-md mt-4 cursor-pointer'>
<FcInfo />
<p className='text-sm'> if you have chosen pppoe username as an autogenerated number in the subscriber account settings
   then you can leave this field blank(Ppoe Username)</p>
  </div>
